cat << 'EOF' > src/test/java/PnComUaTests.java
...
git add src/test/java/PnComUaTests.java
GIT_AUTHOR_DATE="2026-05-14 11:00:00" GIT_COMMITTER_DATE="2026-05-14 11:00:00" git commit -m "Fix: Switch WebDriver configuration to use Firefox (geckodriver)"
git push
